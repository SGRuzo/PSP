...
public class T38 {
    private static String hashGuardado; // Simula almacenamiento en Base de Datos
    ...
    /**
     * Calcula el hash SHA-256 de una contraseña y lo convierte a formato hexadecimal
